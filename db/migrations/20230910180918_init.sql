-- Create "game" table
CREATE TABLE "public"."game" ("id" uuid NOT NULL DEFAULT gen_rand_uuid7(), "name" text NOT NULL, "slug" text NOT NULL GENERATED ALWAYS AS (slugify(name)) STORED, "created" timestamp NULL GENERATED ALWAYS AS (uuid7_time(id)) STORED, "description" text NULL, PRIMARY KEY ("id"));
