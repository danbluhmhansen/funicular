...
CREATE TABLE "public"."actor_skill" (
    "kind_id"  uuid NOT NULL REFERENCES "public"."actor_kind"("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
GRANT SELECT, INSERT, UPDATE, DELETE ON "public"."actor_num_skill" TO "anon";
